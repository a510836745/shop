...
//	public String admin_deleteUser(@RequestParam int uid,HttpServletRequest request) throws Exception {
//		System.out.println("AdminController++++++++++++++++++"+uid);
//		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
//		if(adminuserLogin==null){
//			request.getSession().setAttribute("message","对不起您还没有登录");
//			return "admin/index";
//		}
//		userService.admin_deleteUser(uid);
//		return "redirect:/admin/admin_findAll.action?page=1";
//
//	}
