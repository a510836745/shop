...
function checkUsername() {
	...
	xmlHttp.open("GET","${pageContext.request.contextPath}/loginFindByid.action?username="+ username, true);
	xmlHttp.send(null); 
	...
	<div class="container header">
		<div class="span5">
			<div class="logo">
				...
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.jpg" alt="宠物商城"></img>
				</a>
			</div>
		</div>
		<div class="span9">
						...
						<table>
							<tbody>
								...
								<tr class="register">
									...
									<td>
										<dl>
											<dt>还没有注册账号？<a href="${pageContext.request.contextPath}/regist.action">立即注册</a></dt> 
										</dl>
									</td>
								</tr>
							</tbody>
